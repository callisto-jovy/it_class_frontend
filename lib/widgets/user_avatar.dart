...
///A modified version of the circle_avatar.dart component, with texture filtering.
...
///  * [ListTile], which can combine an icon (such as a [UserAvatar]) with
...
class UserAvatar extends StatelessWidget {
  ...
  ///
  /// Typically a [Text] widget. If the [UserAvatar] is to have an image, use
  ...
  ///
  /// If the [UserAvatar] is to have the user's initials, use [child] instead.
  ...
  /// 20 when the [UserAvatar] is in an unconstrained environment will cause
  /// the avatar to animate from a 20 pixel diameter to a 40 pixel diameter.
  /// However, if the [minRadius] is 40 and the [UserAvatar] has a parent
  ...
  /// 20 when the [UserAvatar] is in an unconstrained environment will cause
  /// the avatar to animate from a 20 pixel diameter to a 40 pixel diameter.
  /// However, if the [maxRadius] is 40 and the [UserAvatar] has a parent
  /// [SizedBox] whose size changes instantaneously from 20 pixels to 40 pixels,
  /// the size will snap to 40 pixels instantly.
  final double? maxRadius;

  ///The filter quality to use on the image.
